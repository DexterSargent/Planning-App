...
TORONTO_GROCERY_INGREDIENTS = [
    ...
    ("Chicken Breast", 165, 1.80, "Meat & Poultry"),
    ("Chicken Thigh", 209, 1.55, "Meat & Poultry"),
    ...
    ("Pork Chops", 196, 1.45, "Meat & Poultry"),
    ("Bacon", 541, 3.10, "Meat & Poultry"),
    ("Turkey Bacon", 368, 2.80, "Meat & Poultry"),

    # Fish & Seafood
    ("Salmon", 208, 3.20, "Fish & Seafood"),
    ("Tilapia", 129, 2.60, "Fish & Seafood"),
    ("Cod", 82, 2.90, "Fish & Seafood"),
    ("Halibut", 111, 5.20, "Fish & Seafood"),
    ("Tuna", 116, 1.90, "Fish & Seafood"),
